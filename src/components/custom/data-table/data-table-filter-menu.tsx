...
export function DataTableFilterMenu<TData>({
  ...
  const { advancedFilters: filters, setAdvancedFilters: setFilters } = (table.options.meta ?? {}) as {
      advancedFilters: ExtendedColumnFilter<TData>[],
      setAdvancedFilters: React.Dispatch<React.SetStateAction<ExtendedColumnFilter<TData>[]>>
  };
