...
import { projectEvents, projectsCost } from "../../../db/schema/projects.ts";
import { withErrorHandler } from "../../../utils/withErrorHandler.ts";
import { EnumProjectEventType, EnumTransactionType } from "../../../db/schema/index.ts";

const listByYearMonthRoutes: FastifyPluginAsyncTypebox = async (app) => {
  app.route({
    url: '/list-by-year-month',
    method: 'GET',
    schema: {
      tags: ['Project Events'],
      summary: 'Get project events by year-month',
      description: 'Get list of project events filtered by year-month based on actualCreatedAt with pagination, sorting, and filtering',
...
export default listByYearMonthRoutes;